...
LaddaButton.propTypes = {
  ...
  'data-color': _react.PropTypes.string,
  // eslint-disable-next-line react/no-unused-prop-types
  'data-size': _react.PropTypes.oneOf(_constants.SIZES),
  // eslint-disable-next-line react/no-unused-prop-types
  'data-style': _react.PropTypes.oneOf(_constants.STYLES),
  // eslint-disable-next-line react/no-unused-prop-types
  'data-spinner-size': _react.PropTypes.number,
  // eslint-disable-next-line react/no-unused-prop-types
  'data-spinner-color': _react.PropTypes.string,
  // eslint-disable-next-line react/no-unused-prop-types
  'data-spinner-lines': _react.PropTypes.number
};
